...
import com.mongo.crud.global.utils.Operations;
...
public class GlobalException {
    ...
    public ResponseEntity<MessageDto> throwNotFountException(ResourceNotFountException e){
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body( new MessageDto( HttpStatus.NOT_FOUND, e.getMessage()));
    }

    @ExceptionHandler(AttibuteException.class)
    public ResponseEntity<MessageDto> throwAttributeException(AttibuteException e){
